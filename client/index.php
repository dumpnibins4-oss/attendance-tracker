                ...
                <div class="w-auto h-full flex flex-col items-center justify-center bg-zinc-500 dark:bg-zinc-800 px-5 py-8 rounded-4xl gap-5">
                    ...
                    <div class="flex flex-col items-center justify-between flex-1">
                        <div class="flex flex-col items-center justify-start w-full h-auto gap-3">
                            <button class="flex items-center justify-center h-12 w-12 rounded-full bg-white dark:bg-zinc-600 hover:bg-white/70 dark:hover:bg-zinc-500 hover:scale-105 cursor-pointer transition-all">
                        ...
                        <div class="flex flex-col items-center justify-start w-full h-auto gap-5">
                            <div class="flex flex-col items-center justify-start w-full h-auto gap-3">
                                <button class="flex items-center justify-center h-12 w-12 rounded-full bg-white dark:bg-zinc-600 hover:bg-white dark:hover:bg-zinc-500 hover:scale-105 cursor-pointer">
                                ...
                                <button class="flex items-center justify-center h-12 w-12 rounded-full bg-white dark:bg-zinc-600 hover:bg-white/70 dark:hover:bg-zinc-500 hover:scale-105 cursor-pointer">
