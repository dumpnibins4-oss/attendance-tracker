<div class="flex flex-col items-center justify-start w-full h-full gap-5 page-content">
    ...
    <div class="flex flex-col w-full h-auto bg-zinc-500 dark:bg-zinc-800 rounded-4xl p-6 gap-4">
        ...
        $faqs = [
            ...
            ['q' => 'Who do I contact for technical issues?', 'a' => 'Reach out to the IT department via email at support@company.com or visit the IT Help Desk.'],
        ];
        ?>
        ...
        <div class="flex flex-col gap-3">
            ...
            <details class="group bg-zinc-600 dark:bg-zinc-700 rounded-2xl overflow-hidden">
                <summary class="flex flex-row items-center justify-between w-full px-5 py-4 cursor-pointer list-none text-white font-medium text-sm hover:bg-zinc-500/50 dark:hover:bg-zinc-600/50 transition-colors">
                    <span><?php echo $faq['q'] ?></span>
                    <i class="fa-solid fa-chevron-down text-zinc-400 text-xs transition-transform group-open:rotate-180"></i>
                </summary>
    ...
    <div class="flex flex-col w-full h-auto bg-zinc-500 dark:bg-zinc-800 rounded-4xl p-6 gap-4">
        <div class="flex flex-row items-center gap-3">
            ...
            <p class="text-white text-xl font-medium">Contact Support</p>
        </div>
        <div class="grid grid-cols-3 gap-4">
            ...
            <div class="flex flex-col items-center justify-center bg-zinc-600 dark:bg-zinc-700 rounded-2xl p-5 gap-3 hover:scale-105 transition-all cursor-pointer">
                ...
                <p class="text-zinc-400 text-xs">(02) 8123-4567</p>
            </div>
            <div class="flex flex-col items-center justify-center bg-zinc-600 dark:bg-zinc-700 rounded-2xl p-5 gap-3 hover:scale-105 transition-all cursor-pointer">
                ...
                <p class="text-zinc-400 text-xs">Room 201, 2nd Floor</p>
            </div>
        </div>
    </div>
</div>
